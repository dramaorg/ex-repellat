# @dramaorg/ex-repellat

<a href="https://www.npmjs.com/package/@dramaorg/ex-repellat"><img alt="npm version" src="https://badge.fury.io/js/@dramaorg/ex-repellat.svg"></a>
<a href="https://npmjs.org/package/@dramaorg/ex-repellat"><img alt="Downloads" src="http://img.shields.io/npm/dm/@dramaorg/ex-repellat.svg"></a>
[![Build Status](https://travis-ci.org/mosch/@dramaorg/ex-repellat.svg?branch=master)](https://travis-ci.org/mosch/@dramaorg/ex-repellat)
[![Design](https://contribute.design/api/shield/mosch/@dramaorg/ex-repellat)](https://contribute.design/mosch/@dramaorg/ex-repellat)
...
Just use your favorite package manager to add `@dramaorg/ex-repellat` to your project:

```sh
yarn add @dramaorg/ex-repellat

npm i --save @dramaorg/ex-repellat

pnpm add @dramaorg/ex-repellat
```

## [Demo](https://@dramaorg/ex-repellat.netlify.com/)
...
import AvatarEditor from '@dramaorg/ex-repellat'
...
drag and drop support to anything really easy. Here is an example how to use it with @dramaorg/ex-repellat:
